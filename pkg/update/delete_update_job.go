...
func DeleteUpdateJob(ctx *UpdateReconcilerReqCtx) (ctrl.Result, error) {
	...
	if err := ctx.Delete(ctx.Context, updateJob, &client.DeleteOptions{PropagationPolicy: &propagationPolicy}); err != nil {
