...
func (r *AlluxioClusterReconciler) Reconcile(context context.Context, req ctrl.Request) (result ctrl.Result, err error) {
	...
	if err = FetchAlluxioClusterFromK8sApiServer(r, req.NamespacedName, alluxioCluster); err != nil {
		return
	}
